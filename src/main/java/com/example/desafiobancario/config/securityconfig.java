...
import com.example.desafiobancario.service.security.autorizaservice;
import com.example.desafiobancario.service.security.filter.securityfilter;
...
public class securityconfig {
    ...
    public AuthenticationManager authenticationManager(PasswordEncoder passwordEncoder) {
        DaoAuthenticationProvider provider = new DaoAuthenticationProvider(autorizaService);
